...
- улучшенные GIF-анимации для солнца, облаков, дождя, снега, грозы, тумана, ветра и жары
...
Перед запуском бота `start.py` генерирует улучшенные GIF-файлы в `assets/weather/`: 384x216, 24 кадра, мягкие свечения, облака, осадки, ветер, туман, жара и дневные/ночные сцены.
